...
// Assuming you're using Express and your data is stored in an array or database

// app.put('/restaurantData/restaurant-tables/:id', (req, res) => {
//   const restaurantId = req.params.id;
//   const updatedData = req.body;

//   // Update the restaurant in your database (pseudo code)
